...
export const popupAddContent = document.querySelector('.popup-card');
export const popupShowImage = document.querySelector('.popup-image');
...
export const contentList = document.querySelector('.content__list');
export const formEditProfile = document.querySelector('.popup__form-profile');
export const formAddContent = document.querySelector('.popup__form-card');
